const notemap = {
  debt: {
  	...
  	date: '5/30/19',
  	content: `
Most engineers consider tech debt shameful. This is wrong. Debt lets you scale faster than otherwise possible and can dramatically limit loss. The truly dangerous thing in software is not tech debt, but rather, its evil twin: risk <span>&#9760;</span>
